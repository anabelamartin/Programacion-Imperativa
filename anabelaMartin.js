...
//         return `el resultado de multiplicar ${num1} y ${num2} es  ${multiplicacion} y es par`
//     } else return `el resultado  de multiplicar ${num1} y ${num2} es  ${multiplicacion}  y es impar `
